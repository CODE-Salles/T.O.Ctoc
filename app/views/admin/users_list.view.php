    ...
    <div class="modal" id="modal">
        ...
        <?php foreach ($users as $key => $user) : ?>
            <div class="modal-content " id="modal-delete-user-<?= $user->id ?>">
                ...
                <form id="form" class="modal-form" method="post" action="users/delete">
                    <div class="form-row">
                    ...
                    <input type="hidden" name="id" value="<?= $user->id ?>" />
                        <div class="modal-footer">
                            <button id="salvar" type="submit" class="button confirm">Salvar2</button>
                            <button id="cancelar" class="button cancel">Cancelar</button>
                        </div>
                </form>
            </div>
            ...
            <div class="modal-content" id="modal-edit-user-<?= $user->id ?>">
                ...
                <form id="form" class="modal-form" method="post" action="users/edit">
                    <div class="form-row">
                        <label for="name" class="modal-label">Nome</label>
            ...
            <div class="modal-content" id="modal-show-user-<?= $user->id ?>">
                ...
                <form id="form" class="modal-form">
                    ...
                    <input type="hidden" name="id" value="<?= $user->id ?>" />
                    <div class="modal-footer">
                        <button id="cancelar" class="button cancel">Fechar</button>
                    </div>
                </form>
            </div>
        <?php endforeach ?>
